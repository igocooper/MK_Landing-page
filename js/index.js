$(function(){
	...
	$('.mk_human_inside').click(function (e) {
        ...
        var size = $('.human_inside').css('width');
        $('.img_wrapper').css('width',size);
        $('.tool_name p').text('Human Inside');
    ...
    $('.mk_av').click(function (e) {
        ...
        var size = $('.av').css('width');
        $('.img_wrapper').css('width',size);
        $('.tool_name p').text('Internet security');
        $('.tool_description p').html(tool_description);
    ...
    $('.mk_anti_theft').click(function (e) {
        ...
        var size = $('.anti_theft').css('width');
        $('.img_wrapper').css('width',size);
        $('.tool_name p').text('Anti-Theft');
        $('.tool_description p').html(tool_description);
    ...
    $('.mk_fast_cleanup').click(function (e) {
        ...
        var size = $('.fast_cleanup').css('width');
        $('.img_wrapper').css('width',size);
        $('.tool_name p').text('fast cleanup');
        $('.tool_description p').html(tool_description);
    ...
    $('.mk_duplicate_finder').click(function (e) {
        ...
        var size = $('.duplicate_finder').css('width');
        $('.img_wrapper').css('width',size);
        $('.tool_name p').text('Duplicates Finder');
        $('.tool_description p').html(tool_description);
     ...
     $('.mk_geek_on_demand').click(function (e) {
        ...
        var size = $('.geek_on_demand').css('width');
        $('.img_wrapper').css('width',size);
        $('.tool_name p').text('Geek on Demand');
        $('.tool_description p').html(tool_description);
    ...
    $('.mk_update_tracker').click(function (e) {
        ...
        var size = $('.update_tracker').css('width');
        $('.img_wrapper').css('width',size);
        $('.tool_name p').text('Update Tracker');
        $('.tool_description p').html(tool_description);
    ...
    $('.mk_backup').click(function (e) {
        ...
        var size = $('.backup').css('width');
        $('.img_wrapper').css('width',size);
        $('.tool_name p').text('Backup');
        $('.tool_description p').html(tool_description);
    ...
    $('.mk_file_recovery').click(function (e) {
        ...
        var size = $('.file_recovery').css('width');
        $('.img_wrapper').css('width',size);
        $('.tool_name p').text('File recovery');
        $('.tool_description p').html(tool_description);
    ...
    $('.mk_disk_usage').click(function (e) {
        ...
        var size = $('.disk_usage').css('width');
        $('.img_wrapper').css('width',size);
        $('.tool_name p').text('Disk Usage');
        $('.tool_description p').html(tool_description);
    ...
    $('.mk_smart_uninstaller').click(function (e) {
        ...
        var size = $('.smart_uninstaller').css('width');
        $('.img_wrapper').css('width',size);
        $('.tool_name p').text('Smart Uninstaller');
        $('.tool_description p').html(tool_description);
    ...
    $('.mk_data_encryptor').click(function (e) {
        ...
        var size = $('.data_encryptor').css('width');
        $('.img_wrapper').css('width',size);
        $('.tool_name p').text('Data Encryptor');
        $('.tool_description p').html(tool_description);
    ...
    $('.mk_default_apps').click(function (e) {
        ...
        var size = $('.default_apps').css('width');
        $('.img_wrapper').css('width',size);
        $('.tool_name p').text('Default Apps');
        $('.tool_description p').html(tool_description);
    ...
    $('.mk_shredder').click(function (e) {
        ...
        var size = $('.shredder').css('width');
        $('.img_wrapper').css('width',size);
        $('.tool_name p').text('Shredder');
        $('.tool_description p').html(tool_description);
    ...
    $('.mk_files_finder').click(function (e) {
        ...
        var size = $('.files_finder').css('width');
        $('.img_wrapper').css('width',size);
        $('.tool_name p').text('Files Finder');
        $('.tool_description p').html(tool_description);
    ...
    $('.mk_login_items').click(function (e) {
        ...
        var size = $('.login_items').css('width');
        $('.img_wrapper').css('width',size);
        $('.tool_name p').text('Login Items');
        $('.tool_description p').html(tool_description);
    ...
    $('.mk_memory_cleaner').click(function (e) {
        ...
        var size = $('.memory_cleaner').css('width');
        $('.img_wrapper').css('width',size);
        $('.tool_name p').text('Memory Cleaner');
        $('.tool_description p').html(tool_description);
